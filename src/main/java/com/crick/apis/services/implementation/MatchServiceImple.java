package com.crick.apis.services.implementation;
...
@Service
public class MatchServiceImple implements MatchService {

    private MatchRepo matchRepo;

    public MatchServiceImple(MatchRepo matchRepo) {
        this.matchRepo = matchRepo;
    }

    //Get match history of all matches from the DB
    @Override
    ...
    private void updateMatchesInDb(Match match1) {
